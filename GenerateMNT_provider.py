...
from .GenerateMNT_algorithm import GenerateMNTAlgorithm


class GenerateMNTProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(GenerateMNTAlgorithm())
