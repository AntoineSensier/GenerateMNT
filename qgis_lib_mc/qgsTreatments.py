...
# TODO TO COMMIT
def applyGetLayerExtent(input_layer, output, context=None,feedback=None):
    parameters = {
        'INPUT': input_layer,
        'ROUND_TO': 0,
        'OUTPUT': output
...
def applyClipRasterByExtent(input_raster, input_extent, output, data_type=0, context=None,feedback=None):
    parameters = {
